...
function Contact() {
  ...
  const socialLinks = [
    { name: "Twitter", icon: "𝕏", link: "#", color: "hover:bg-cyan-500" },
    { name: "LinkedIn", icon: "in", link: "#", color: "hover:bg-blue-500" },
    { name: "GitHub", icon: "G", link: "#", color: "hover:bg-slate-700" },
    { name: "Instagram", icon: "IG", link: "#", color: "hover:bg-pink-500" },
    { name: "Discord", icon: "D", link: "#", color: "hover:bg-indigo-500" }
  ];
      ...
      <div className="relative z-10 px-6 py-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              <p className="text-xl text-slate-300 leading-relaxed mb-8">
                Have questions or want to get involved? We'd love to hear from you. Fill out the form and we'll respond within 24 hours.
              </p>
              <div className="w-32 h-1 bg-gradient-to-r from-cyan-400 via-blue-400 to-transparent lg:mx-0 mx-auto"></div>
              
              {/* Quick Stats */}
              <div className="grid grid-cols-3 gap-4 mt-12">
                <div className="text-center lg:text-left">
                  <div className="text-3xl font-black bg-gradient-to-r from-cyan-400 to-blue-400 bg-clip-text text-transparent">24h</div>
                  <div className="text-sm text-slate-400">Response Time</div>
                </div>
                <div className="text-center lg:text-left">
                  <div className="text-3xl font-black bg-gradient-to-r from-cyan-400 to-blue-400 bg-clip-text text-transparent">500+</div>
                  <div className="text-sm text-slate-400">Messages Handled</div>
                </div>
                <div className="text-center lg:text-left">
                  <div className="text-3xl font-black bg-gradient-to-r from-cyan-400 to-blue-400 bg-clip-text text-transparent">24/7</div>
            ...
            {/* Right: Contact Form */}
            <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 md:p-10 hover:border-cyan-400/50 transition-all duration-500 shadow-2xl">
              ...
              {/* Success Message */}
              {success && (
                <div className="mb-6 p-4 bg-green-500/10 border border-green-400/50 rounded-xl flex items-start gap-3">
              ...
              {/* Error Message */}
              {error && (
                <div className="mb-6 p-4 bg-red-500/10 border border-red-400/50 rounded-xl flex items-start gap-3">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-5 py-3.5 bg-white/5 border border-white/10 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:border-cyan-400/50 focus:bg-white/10 transition-all"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    required
                    rows="4"
                    className="w-full px-5 py-3.5 bg-white/5 border border-white/10 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:border-cyan-400/50 focus:bg-white/10 transition-all resize-none"
        ...
        <div className="max-w-7xl mx-auto mb-20">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-black text-white mb-4">Other Ways to Reach Us</h2>
        ...
        <div className="max-w-7xl mx-auto mb-20">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Map */}
            <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl overflow-hidden hover:border-cyan-400/50 transition-all duration-500">
              <div className="h-64 bg-gradient-to-br from-cyan-500/10 to-blue-500/10 flex items-center justify-center">
                <div className="text-center">
                  <svg className="w-16 h-16 mx-auto mb-3 text-cyan-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                  </svg>
                  <p className="text-slate-300 font-semibold">Find us on Campus</p>
                  <p className="text-slate-500 text-sm mt-1">Main Campus, Building A</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 hover:border-cyan-400/50 transition-all duration-500">
              <h3 className="text-2xl font-black text-white mb-3">Follow Us</h3>
              <p className="text-slate-400 mb-6 text-sm">Stay connected on social media</p>
              <div className="flex flex-wrap gap-3">
                {socialLinks.map((social) => (
                  <a
                    key={social.name}
                    href={social.link}
                    className={`w-12 h-12 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-white font-bold transition-all duration-300 ${social.color} hover:border-transparent hover:scale-110 hover:shadow-lg`}
                    title={social.name}
                  >
            ...
            {/* Office Hours */}
            <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 hover:border-cyan-400/50 transition-all duration-500">
              <h3 className="text-2xl font-black text-white mb-3">Office Hours</h3>
              <div className="space-y-3">
                <div className="flex justify-between items-center text-sm">
                  <span className="text-slate-300 font-semibold">Mon - Fri</span>
                  <span className="text-cyan-400 font-bold">9AM - 5PM</span>
                </div>
                <div className="flex justify-between items-center text-sm">
                  <span className="text-slate-300 font-semibold">Saturday</span>
                  <span className="text-cyan-400 font-bold">10AM - 2PM</span>
                </div>
                <div className="flex justify-between items-center text-sm">
          ...
          <div className="space-y-4">
            {faqs.map((faq, index) => (
              ...
              >
                ...
                <p className="text-slate-400 pl-8 text-sm">{faq.answer}</p>
              </div>
            ))}
          </div>
        </div>
